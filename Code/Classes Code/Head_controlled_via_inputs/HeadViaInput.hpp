...
//all variables used in this section are set here
...
//variables that will be changed and saved 
...
//starting the servo driver board
  void startUP(){
    neck.begin();
    //Servo Board startup
...
//calculating the angles from the inputted joystick values and triggers
  void NeckCalc(){
    ...
    //if menu button pressed switch triggers to tilting the head if not pressed then let the triggers controll the anntenni
